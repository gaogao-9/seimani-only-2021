      ...
      >
        ...
        <Card title="コスプレ参加をする方へ">
          <Card.Section title="感染症対策に関するルール">
            ...
            <br />
            ・当日の状況によっては、コスプレ更衣室スペースの提供を中止する場合がございます。その場合、コスプレ登録・更衣室使用料は返金いたします。
          </Card.Section>
          <Card.Section title="入場について">
            ...
            <br />
            イベント入場料の他、コスプレ登録・更衣室使用料としてサークル参加者は【500円】、一般参加者は【1500円】を頂戴する予定です。
            <br />
            お支払い方法につきましては後日改めて告知いたします。
            <br />
          ...
          <Card.Section title="コスプレ可能エリアについて">
            イベント会場エリア内のみがコスプレ可能エリアとなります。
            <br />
            コスプレと判断される服装、メイクで会場外へ出られることはお控えください。
          </Card.Section>
