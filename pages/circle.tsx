      ...
      >
        <Card title="サークル参加をする方へ">
          ...
          <Card.Section title="オンラインイベントのご案内">
            前回から形を変えて、オンライン上でサークル参加総理の皆さんの通販サイト（boothなど）をまとめて紹介する場を、主催が提供する方向で調整中です。
            <br />
            また、現地参加が難しいサークルの皆さんも参加いただけるよう、オンラインのみのサークル参加も受け付ける予定です。
            <br />
            現地参加が難しい総理のためにも、ぜひ通販での参加/頒布をご検討ください！
            <br />
            オンラインイベントの詳細については追って告知いたします。ご興味のある方は主催メールアドレスまでご連絡ください。
          </Card.Section>
